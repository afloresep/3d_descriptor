...
class Base3DDescriptor(ABC):
    ...
    def compute(self, mol): 
        ...
        Args:
            mol (rdkit.Chem.Mol): RDKit molecule object or a similar compatible object.
        
        Returns:
            Tuple[float, float, float]:  A tuple representing the (x, y, z) 3D coordinates 
            calculated from the molecule object
        """
